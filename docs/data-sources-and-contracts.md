...
```
<root>/ard/static/{sources|sources/<source>/<rev>}|sources|derived/<product>/<geometry_id>}/
...
Secondary land/Imperviousness products accept exact COG contracts via
`data.secondary.contract.Contract`; each `BandSpec` carries
